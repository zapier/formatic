...
module.exports = React.createClass({
  ...
  renderDefault: function renderDefault() {
    if (this.props.isEnteringCustomValue) {
      return React.createElement("input", { className: cx(_.extend({}, this.props.classes)), ref: "customInput", type: "text", value: this.props.field.value,
