  ...
  plugin.exports = React.createClass({
    ...
    render: function () {
      ...
      return plugin.component('field')({
        ...
        replaceChoices && replaceChoices.length === 0 ? null : R.a({ref: 'toggle', href: 'JavaScript' + ':', onClick: this.onToggleChoices}, 'Insert...'),
