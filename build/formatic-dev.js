...
module.exports = React.createClass({
  ...
  renderDefault: function renderDefault() {
    ...
    var textBoxClasses = cx(_.extend({}, this.props.classes, { "pretty-text-box": true, "form-control": true }));
