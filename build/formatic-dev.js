...
},{"../../mixins/field":41,"../../mixins/resize":43,"../../mixins/undo-stack":45,"../../utils":50}],12:[function(require,module,exports){
(function (global){
"use strict";
...
module.exports = React.createClass({
  ...
  renderDefault: function renderDefault() {
    ...
    var element = React.createElement(
      "div",
      { onMouseLeave: this.switchToReadOnly, onMouseEnter: this.switchToCodeMirror },
      React.createElement(
        "div",
        { className: "pretty-text-box form-control", tabIndex: this.props.tabIndex },
        React.createElement("div", { ref: "textBox", dangerouslySetInnerHTML: { __html: html } })
      ),
...
},{"../../mixins/field":41,"./choices-dropdown":6,"./tag-translator":16}],13:[function(require,module,exports){
(function (global){
"use strict";
