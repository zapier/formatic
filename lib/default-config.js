...
export default function(config) {
  ...
  return {
    ...
    // Get the help text placement for a field. Valid values are 'before' and 'after'. Default is 'before'.
    fieldHelpTextPlacement: function(field) {
      return field.helpTextPlacement || 'before';
    },
