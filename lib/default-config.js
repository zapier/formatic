...
export default function(config) {
  ...
  return {
    ...
    renderTag: function(tagName, tagProps) {
    ...
    createRootField: function(props) {
      ...
      field.fieldTypeName = config.fieldTypeName(field);
    ...
    createChildField: function(parentField, options) {
      ...
      childField.fieldTypeName = config.fieldTypeName(childField);
    ...
    fieldTypeName: function(field) {
      ...
      return config.fieldTemplateTypeName(field);
    },
