...
export default createReactClass({
  ...
  renderDefault: function () {
    ...
    const removeItemControl = config.createElement('remove-item', {
      field, onClick: this.onRemove, onMaybeRemove: this.props.onMaybeRemove,
    ...
    const moveItemForward = this.props.index < (this.props.numItems - 1) ?
      config.createElement('move-item-forward', { field, onClick: this.onMoveForward, classes: { 'is-first-item': isFirstItem } }) :
      null;

    const moveItemBack = this.props.index > 0 ?
      config.createElement('move-item-back', { field, onClick: this.onMoveBack, classes: { 'is-last-item': isLastMoveableItem } }) :
      null;
