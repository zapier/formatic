...
export default createReactClass({
  ...
  getInitialState: function() {
    ...
    const isDefaultValue = this.props.field.value === this.props.config.fieldTemplateDefaultValue(this.props.field);
    return {
  ...
  renderDefault: function () {
    ...
    const choicesOrLoading = (
      <div role="listbox" ref={ref(this, 'container')} tabIndex="0" onKeyDown={this.onKeyDown} className={cx(_.extend({}, this.props.classes, {'choices-open': this.state.isChoicesOpen}))}
  ...
  getDisplayValue: function () {
    ...
    const isDefaultValue = currentValue === this.props.config.fieldTemplateDefaultValue(this.props.field);
