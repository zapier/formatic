...
module.exports = React.createClass({
  ...
  insertBtn: function () {
    ...
    return this.props.config.createElement('insert-button',
  ...
  createCodeMirrorEditor: function () {
    const value = this.hasPlaceholder() ? this.props.field.placeholder : String(this.state.value);
  ...
  createReadonlyEditor: function () {
    ...
    if (this.hasPlaceholder()) {
      return React.render(<span>{this.props.field.placeholder}</span>, textBoxNode);
    }
