...
module.exports = React.createClass({
  ...
  renderDefault: function () {
    ...
    const tabIndex = this.state.codeMirrorMode ? null : (this.props.tabIndex || 0);

    // Render read-only version.
    return (
      <div className={cx({'pretty-text-wrapper': true, 'choices-open': this.state.isChoicesOpen})} onMouseEnter={this.switchToCodeMirror}>
        <div className={textBoxClasses} tabIndex={tabIndex} onFocus={this.onFocus} onBlur={this.props.onBlur}>
