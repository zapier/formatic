    ...
    return (
      ...
      >
        {config.cssTransitionWrapper(
          search,
          <ul key="choices" ref={ref(this, 'choices')} className="choices">
            {choices.map(
              function(choice, i) {
                ...
                if (choice.value === '///loading///') {
                  choiceElement = (
                    <a href={'JavaScript' + ':'} onClick={this.onClose}>
                      <span className="choice-label">
                        {config.createElement('loading-choice', {
                          field: this.props.field,
                        })}
                      </span>
                    </a>
                  ...
                  const labelClasses = 'choice-label ' + choice.action;
                  const anchorClasses = 'action-choice ' + choice.action;

                  choiceElement = (
                    <a
                      href={'JavaScript' + ':'}
                      onClick={this.onChoiceAction.bind(this, choice)}
                      className={anchorClasses}
                    >
                      <span className={labelClasses}>
                        {choice.label ||
                          this.props.config.actionChoiceLabel(choice.action)}
                      </span>
                  ...
                  choiceElement = (
                    <a
                      href={'JavaScript' + ':'}
                      onClick={this.onHeaderClick.bind(this, choice)}
                    >
                      {config.createElement('choice-section-header', {
                        choice,
                        isOpen:
                          this.state.openSections.indexOf(choice.sectionKey) !==
                          -1,
