...
export default createReactClass({
  ...
  hasOneSection: function () {
    const sectionHeaders = this.props.choices.filter(function (c) { return c.sectionKey; });
  ...
  visibleChoicesInfo(props = this.props) {
    ...
    const alwaysExanded = !props.isAccordionAlwaysCollapsable && this.hasOneSection() || this.state.searchString;
