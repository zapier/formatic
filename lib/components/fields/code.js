...
export default createReactClass({
  ...
  renderDefault: function () {
    ...
    const props = { field, plain: this.props.plain };

    const textBoxClasses = cx(_.extend({}, this.props.classes, {'pretty-text-box': true}));

    // Render read-only version.
    const element = (
      <div className="pretty-text-wrapper">
        <div role="presentation" className={textBoxClasses} tabIndex={this.tabIndex()} onFocus={this.onFocusAction} onBlur={this.onBlurAction}>
