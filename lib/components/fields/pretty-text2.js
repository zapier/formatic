...
module.exports = React.createClass({
  ...
  componentWillReceiveProps: function(nextProps) {
    var replaceState = this.getReplaceState(nextProps);
    var nextState = {
      replaceChoices: replaceState.replaceChoices,
      replaceChoicesLabels: replaceState.replaceChoicesLabels
    };
    ...
    console.log('new choices', nextState.replaceChoices, 'new labels', nextState.replaceChoicesLabels);
  ...
  renderDefault: function () {
    ...
    var choices = config.createElement('choices', {
      ref: 'choices',
      choices: this.state.replaceChoices, open: this.state.isChoicesOpen,
    ...
    var element = (
      <div onMouseEnter={this.switchToCodeMirror}>
        ...
        <a ref="toggle" href="Javascript:" onClick={this.onToggleChoices}>Insert...</a>
        {choices}
      </div>
    );
