...
var TaggedTextEditor = React.createClass({
  ...
  render: function() {
    ...
    return (
      <div onMouseLeave={this.switchToReadOnly} onMouseEnter={this.switchToCodeMirror} className="textBox">
        <div id="textBox" ref="textBox" dangerouslySetInnerHTML={{__html: html}} />
        <div>After text box</div>
      </div>
    );
  },
