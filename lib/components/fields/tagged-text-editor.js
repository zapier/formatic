...
var TaggedTextEditor = React.createClass({
  ...
  render: function() {
    ...
    return (
      <div onMouseLeave={this.switchToReadOnly} onMouseEnter={this.switchToCodeMirror} className="prettyBox">
        <div id="prettyBox" ref="textBox" dangerouslySetInnerHTML={{__html: html}} />
      </div>
    );
  },
