...
export default createReactClass({
  ...
  renderDefault: function () {
    ...
    return config.createElement('field', {
      config, field, plain: this.props.plain, classes: this.props.classes
    }, config.createElement('pretty-select-value', {
      choices: this.state.choices, isAccordion: field.isAccordion, isAccordionAlwaysCollapsable: field.isAccordionAlwaysCollapsable, field, onChange: this.onChange, onAction: this.onBubbleAction
    }));
  }
});
