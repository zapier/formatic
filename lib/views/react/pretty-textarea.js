...
module.exports = React.createClass({
  ...
  onSelect: function () {
    ...
    var prevPos = this.moveOffTag(pos, this.state.tokens, this.state.indexMap, -1);
    var nextPos = this.moveOffTag(pos, this.state.tokens, this.state.indexMap);
    var newPos = nextPos;
    var isLeft = this.state.pos - pos === 1;
    var isRight = pos - this.state.pos === 1;
    if (isLeft || (!isRight && (nextPos - pos > pos - prevPos))) {
      newPos = prevPos;
    }
    this.setState({
      pos: newPos
