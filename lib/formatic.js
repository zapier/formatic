...
defaultFormatic.registerPlugins(
  ...
  ['components.formatic', require('./components/formatic')],
  ['components.root', require('./components/root')],
  ['components.field', require('./components/field')],
  ['components.label', require('./components/label')],
  ['components.help', require('./components/help')],
  ['components.fieldset', require('./components/fieldset')],
  ['components.text', require('./components/text')],
  ['components.textarea', require('./components/textarea')],
  ['components.select', require('./components/select')],
  ['components.list', require('./components/list')],
  ['components.list-control', require('./components/list-control')],
  ['components.list-item', require('./components/list-item')],
  ['components.list-item-value', require('./components/list-item-value')],
  ['components.list-item-control', require('./components/list-item-control')],
  ['components.item-choices', require('./components/item-choices')],
  ['components.add-item', require('./components/add-item')],
  ['components.remove-item', require('./components/remove-item')],
  ['components.move-item-back', require('./components/move-item-back')],
  ['components.move-item-forward', require('./components/move-item-forward')],
  ['components.json', require('./components/json')],
  ['components.checkbox-list', require('./components/checkbox-list')],

  ['bootstrap', require('./plugins/bootstrap')],

  ['types.root', require('./types/root')],
  ...
  ['stores.memory', require('./stores/memory')]
