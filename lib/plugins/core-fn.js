...
module.exports = function (formatic) {
  ...
  formatic.form.append = function (fieldDef) {
    this.modify(function (field) {
      ...
      var child = this.childFromCursor(fields.get(nextIndex), nextIndex);
  ...
  formatic.form.find = function (key, fromField, upFromIndex) {
    ...
    if (fromField._path.length > 0) {
      var parent = this.parentFromPath(fromField._path);
      return this.find(key, parent, fromField.index());
    }
