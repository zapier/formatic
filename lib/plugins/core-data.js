...
module.exports = function (formatic) {
  ...
  formatic.form.wrap('init', function (next) {
    ...
    this.emitter.on('insert', function (field, index) {
      this.onInsert(field, index);
    }.bind(this));
  ...
  formatic.form.method('onInsert', function (field, index) {
    if (field.key) {
      ...
      if (_.isArray(parent)) {
        if (typeof index === 'undefined' || index > parent.length) {
          index = parent.length;
        }
